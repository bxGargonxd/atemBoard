...
public:
     ...
     */
    void setTimeout(const boost::posix_time::time_duration& t) noexcept;
...
private:
    ...
    {
    public:
        ReadSetupParameters() noexcept : fixedSize(false), delim(""), data(0), size(0) {}
     ...
     */
    void timeoutExpired(const boost::system::error_code& error) noexcept;
     ...
     */
    void readCompleted(const boost::system::error_code& error, const size_t bytesTransferred) noexcept;
